...
<template>
  <div class="min-h-screen bg-brand-dark text-white flex flex-col items-center justify-center p-4 md:p-6 relative overflow-x-hidden">
    ...
    <div class="z-10 w-full max-w-4xl flex flex-col items-center gap-8 md:gap-12 animate-fade-in py-12 md:py-0">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 w-full">
        ...
        <NuxtLink
            ...
            class="group relative h-64 md:h-72 glass rounded-[2rem] overflow-hidden flex flex-col items-center justify-center text-center p-6 md:p-8 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-brand-red/20">
          ...
          <div class="relative z-10 transform transition-transform duration-500 group-hover:-translate-y-2">
            <div class="mb-4 md:mb-6 p-4 rounded-full bg-white/5 border border-white/10 group-hover:bg-brand-red/20 group-hover:border-brand-red/30 transition-colors duration-300">
              <Icon name="heroicons:film" size="3em" class="text-gray-300 group-hover:text-brand-red transition-colors duration-300"/>
            </div>
            <h2 class="text-2xl md:text-3xl font-bold font-display mb-2">{{ t('home.watch') }}</h2>
        ...
        <NuxtLink
            to="/decide?mode=food"
            class="group relative h-64 md:h-72 glass rounded-[2rem] overflow-hidden flex flex-col items-center justify-center text-center p-6 md:p-8 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-yellow-500/20">
          
          <div class="absolute inset-0 bg-gradient-to-br from-yellow-500/20 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"/>
          
          <div class="relative z-10 transform transition-transform duration-500 group-hover:-translate-y-2">
            <div class="mb-4 md:mb-6 p-4 rounded-full bg-white/5 border border-white/10 group-hover:bg-yellow-500/20 group-hover:border-yellow-500/30 transition-colors duration-300">
              <Icon name="heroicons:cake" size="3em" class="text-gray-300 group-hover:text-yellow-500 transition-colors duration-300"/>
            </div>
            <h2 class="text-2xl md:text-3xl font-bold font-display mb-2">{{ t('home.eat') }}</h2>
      ...
      <NuxtLink
          to="/squad"
          class="group relative w-full glass rounded-[2rem] overflow-hidden flex flex-col sm:flex-row items-center justify-between p-6 md:p-8 gap-4 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple-500/20">
        ...
        <div class="relative z-10 flex flex-col sm:flex-row items-center gap-4 sm:gap-6 text-center sm:text-left">
          ...
          <div>
            <h2 class="text-2xl md:text-3xl font-bold font-display mb-1">{{ t('home.squad') }}</h2>
